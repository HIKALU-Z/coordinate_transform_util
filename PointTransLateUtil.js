const GPS = {
  ...
  gcj_decrypt_exact: function (gcjLat, gcjLon) {
    ...
    const dLat = initDelta,
      dLon = initDelta;
    const mLat = gcjLat - dLat,
      mLon = gcjLon - dLon;
    const pLat = gcjLat + dLat,
      pLon = gcjLon + dLon;
    let wgsLat,
      wgsLon,
      i = 0;
  ...
  mercator_encrypt: function (wgsLat, wgsLon) {
    ...
    /*
        if ((Math.abs(wgsLon) > 180 || Math.abs(wgsLat) > 90))
            return null;
        const x = 6378137.0 * wgsLon * 0.017453292519943295;
  ...
  mercator_decrypt: function (mercatorLat, mercatorLon) {
    ...
    const y = (mercatorLat / 20037508.34) * 180;
    y =
      (180 / this.PI) *
    ...
    /*
        ...
        if ((Math.abs(mercatorLon) > 20037508.3427892) || (Math.abs(mercatorLat) > 20037508.3427892))
            return null;
        const a = mercatorLon / 6378137.0 * 57.295779513082323;
